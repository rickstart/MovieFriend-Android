...
import com.rickstart.moviefriend.BuildConfig;
...
public abstract class ImageWorker {
    ...
    protected ImageWorker(Context context, int columnWidth) {
    ...
    public void loadImage(Object data, ImageView imageView) {
        ...
        if (value != null) {
            ...
            Bitmap bitmap = value.getBitmap().createScaledBitmap(value.getBitmap(),columnWidth,columnWidth + (columnWidth/3) ,false);
    ...
    public void setLoadingImage(int resId) {
        ...
        //mLoadingBitmap = bitmap.createScaledBitmap(bitmap,columnWidth,columnWidth+(columnWidth/3),false);
    ...
    private class BitmapWorkerTask extends AsyncTask<Void, Void, BitmapDrawable> {
        ...
        protected void onPostExecute(BitmapDrawable value) {
            ...
            if (value != null && imageView != null) {
                ...
                Bitmap bitmap = value.getBitmap().createScaledBitmap(value.getBitmap(),560,746,false);
                value = new BitmapDrawable(mResources,bitmap);
